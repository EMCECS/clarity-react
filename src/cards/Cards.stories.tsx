...
storiesOf("Cards", module)
    ...
    .add("Clickable Card", () => (
        <div>
            <div className="clr-row">
                <Card className="clr-col-lg-4 clr-col-md-8 clr-col-12" onClick={action("onclick - card image top")}>
                    <CardImage>
                    ...
                    <CardBlock>
                        <CardText>
                            ...
                            amet sit rem. Ipsam maiores incidunt eum quasi enim! Corporis sunt nisi totam molestias quam
                            commodi maxime mollitia.
                        </CardText>
                    </CardBlock>
                </Card>
                <Card className="clr-col-lg-4 clr-col-md-8 clr-col-12" onClick={action("onclick - card image bottom")}>
                    <CardBlock>
                        <CardText>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci consectetur magnam eos
                            amet sit rem. Ipsam maiores incidunt eum quasi enim! Corporis sunt nisi totam molestias quam
                ...
                <Card className="clr-col-lg-4 clr-col-md-8 clr-col-12" onClick={action("onclick - card image middle")}>
                    <CardBlock>
    ...
    .add("Alerts in Cards", () => (
        <div className="clr-row">
            <Card className="clr-col-lg-4 clr-col-md-8 clr-col-12">
                <CardBlock>
                    <Alert
                        ...
                        closeable={true}
                    >
                        <AlertItem icon={<Icon shape="exclamation-triangle" />}>Use small alerts in a card</AlertItem>
                    </Alert>
                    <CardMediaBlock
                        image={require("./placeholder_350x150.png")}
                        title="Project A"
    ...
    .add("Lists in Cards", () => (
        <div className="clr-row">
            <Card header="Unordered Lists" className="clr-col-lg-4 clr-col-12">
                <CardBlock>
                    <CardText>
            ...
            <Card header="Ordered Lists" className="clr-col-lg-4 clr-col-12">
                <CardBlock>
                    <CardText>
                        Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                        consequat.
            ...
            <Card header="Unstyled Lists" className="clr-col-lg-4 clr-col-12">
                <CardBlock>
                    <CardText>
                        Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                        consequat.
