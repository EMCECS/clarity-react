...
import {Wizard, WizardSize, WizardStep, WizardValidationType} from ".";
import {Button} from "../forms/button";
import {Badge, BadgeColor, BadgeStatus} from "../emphasis/badges";
    ...
    .add("Wizard Sizes", () => (
        <div className="clr-row">
            <div className="clr-col-12">
                ...
                >
                    <WizardStep key={"page1"} name={"Page 1"} />
                    <WizardStep key={"page2"} name={"Page 2"} />
                    <WizardStep key={"page3"} name={"Page 3"} />
                </Wizard>
            </div>
        </div>
    ))
