export class ClassNames {
    ...
    public static Header4: string = "header-4";
    public static Header5: string = "header-5";
    public static Header6: string = "header-6";
    public static Header7: string = "header-7";
    public static OverflowTrigger: string = "header-overflow-trigger";
    public static OverflowMenu: string = "open-overflow-menu";
